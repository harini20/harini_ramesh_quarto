...
# Altair chart for Top 10
top_chart = alt.Chart(top10_countries).mark_bar().encode(
    x=alt.X('obs_value:Q', title='% Schools with Basic Drinking Water'),
    y=alt.Y('country:N', sort='-x'),
    color=alt.Color('country:N', scale=alt.Scale(domain=top10_countries['country'].tolist(), range=custom_colors), legend=None),
    tooltip=['country:N', 'obs_value:Q']
).properties(
    width=600,
    height=400,
    title='Top 10 Countries: Schools with Basic Drinking Water Access'
)

# Altair chart for Bottom 10
bottom_chart = alt.Chart(bottom10_countries).mark_bar().encode(
    x=alt.X('obs_value:Q', title='% Schools with Basic Drinking Water'),
    y=alt.Y('country:N', sort='x'),
    color=alt.Color('country:N', scale=alt.Scale(domain=bottom10_countries['country'].tolist(), range=custom_colors), legend=None),
    tooltip=['country:N', 'obs_value:Q']
).properties(
    width=600,
    height=350,
    title='Bottom 10 Countries: Schools with Basic Drinking Water Access'
)
